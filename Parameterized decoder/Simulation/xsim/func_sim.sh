...
#
# Script generated by Vivado on Sat Sep 05 03:28:08 +0300 2026
# SW Build 6511674 on Tue Jun 16 11:02:23 MDT 2026
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2026 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : func_sim.sh
...
#
# Usage        : func_sim.sh
#                func_sim.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                func_sim.sh [-rerun]
#                func_sim.sh [-reset_run]
#                func_sim.sh [-clean]
#                func_sim.sh [-reset_log]
#                func_sim.sh [-help]
#
...
# script info
echo -e "func_sim.sh - Script generated by export_simulation (Vivado v2026.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./func_sim.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot func_sim xil_defaultlib.func_sim xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim func_sim -key {Behavioral:sim_1:Functional:func_sim} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb func_sim.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./func_sim.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: func_sim.sh [-help]\n\
Usage: func_sim.sh [-step]\n\
Usage: func_sim.sh [-lib_map_path]\n\
Usage: func_sim.sh [-rerun]\n\
Usage: func_sim.sh [-reset_run]\n\
Usage: func_sim.sh [-clean]\n\
Usage: func_sim.sh [-reset_log]\n\
Usage: func_sim.sh [-keep_index]\n\
Usage: func_sim.sh [-noclean_files]\n\n\
